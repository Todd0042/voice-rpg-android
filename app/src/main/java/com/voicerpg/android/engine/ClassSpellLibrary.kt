...
object ClassSpellLibrary {
    ...
    val CHANTER_SPELLS = listOf(
        ...
        Spell("haste_cadence", "Haste Cadence", SpellSchool.HOLY, basePower = 65, mpCost = 15, isHeal = true, status = "BLESS", description = "Rhythmic breath healing and quickening hero ATB", exampleChant = "Swift rhythm hasten our fellowship!"),
    ...
    val SHADOWWEAVER_SPELLS = listOf(
        ...
        Spell("void_drain", "Void Drain", SpellSchool.SHADOW, basePower = 55, mpCost = 14, lifesteal = true, status = "CORRODE", description = "Siphons life essence from enemy to caster", exampleChant = "Void siphon drain their life essence!"),
